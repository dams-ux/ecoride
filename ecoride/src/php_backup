...
<body>
    ...
    <div class="navbar-center">
        <a href="../pages/home.php" class="navbar-btn">Accueil</a>
        <a href="../pages/covoiturage.php" class="navbar-btn">Covoiturage</a>
    ...
    <div class="navbar-right" style="position:relative;">
        <div class="dropdown-user">
            ...
            <div class="dropdown-content">
                <a href="../pages/login.php">Connexion </a><svg width="16" height="16" viewBox="0 0 24 24" style="vertical-align:middle;"><polyline points="9 6 15 12 9 18" fill="none" stroke="#222" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                <a href="../pages/signup.php">Inscription <svg width="16" height="16" viewBox="0 0 24 24" style="vertical-align:middle;"><polyline points="9 6 15 12 9 18" fill="none" stroke="#222" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
            </div>
        </div>
